...
public class SendSMS {
    ...
    public void msgsend() {
            ...
            String from = "surajsms1@ipipi.com";
            //ur userid@ipipi.com
            //This mobile number need not be registered with ipipi.com
            String to1 = "919777734449@sms.ipipi.com";
            String to2 = "918885270757@sms.ipipi.com";
            String body = "Happy Sunday,Happy chicken time";
